  ...
  return (
    <section className="relative bg-black text-white py-20 px-6">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        {/* Área de demo */}
        <div
          className="rounded-xl bg-white/5 backdrop-blur-md border border-white/10 shadow-lg max-w-4xl mx-auto overflow-hidden transform transition-all duration-700 hover:scale-105"
        >
