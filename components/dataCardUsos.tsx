	...
	return (
		<div className="mt-10">
			...
			<div className="mb-4 text-sm text-foreground p-3 rounded-md ">
				<span className="font-medium">Top paths</span> han sido movidos a{' '}
				<span className="font-semibold">Observabilidad</span> dentro de cada
				proyecto.
			</div>
				...
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							La transferencia de datos entre la red de Edge de tu sitio y los
							usuarios finales.
						</p>
					</div>
				</div>
