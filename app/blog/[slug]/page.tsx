...
export default async function PostPage({ params }: PostPageProps){
    ...
    return (
        <>
            <NavbarBLog/>
            <article className="px-6 md:px-20 py-16 mx-w-4xl mx-auto pt-30">
                ...
                <div className="prose prose-lg prose-invert text-muted-foreground" dangerouslySetInnerHTML={{ __html: contentHtml }} />
            </article>
        </>
    )
}