// Hasta que no haya plantillas no voy a descomentar el codigo
			...
			<section className="col-span-full md:col-span-6 min-h-48 md:min-h-96">
				<Card className="h-full flex items-center justify-center">
					<CardContent className="flex flex-col gap-y-8 items-center">
						...
						<IconAdjustmentsHorizontal className="w-12 h-12 text-neutral-600" />
						<Link  
							href="/dashboard/nuevo/personalizado"
							className={cn(
