		...
		<div className="grid grid-cols-12 px-44 gap-x-16 gap-y-4 pb-24">
			...
			<section className="col-span-3 space-y-6">
				...
				<div>
					...
					<Badge variant="secondary" className="bg-neutral-200" >Analíticas</Badge>
				</div>
				<div>
				...
				<div>
					...
					<Button asChild variant="link" className="text-blue-500 text-sm px-0 block font-normal" >
			...
			<section className="col-span-9 space-y-4">
				...
				<div className="space-y-2" >
					...
					<p className="text-neutral-800" >Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam ea ipsa vitae nam sint, corporis magni dolorum ducimus molestias hic totam quis eaque tempore quae unde. Magnam magni distinctio veniam at aliquam pariatur debitis, facilis quia incidunt, iure, possimus neque placeat. Libero iure eius asperiores illum dolorem, consequuntur fuga non!</p>
				</div>
			</section>
		</div>
	)
